...
<div class="row justify-content-center">
        <div class="col-8 m-3">
            ...
            <form action="<?= base_url('dashboard/update_notice/').$notice['notice_id'];?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <!-- <div class="mb-3">
                    ...
                    <input type="date" class="form-control"  id="date" name="date" value="<?= $notice['time']?>" >
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="desc" id="desc" cols="30" rows="10"><?= $notice['desc']?></textarea>
                ...
                <div class="mb-3">
                    ...
                    <img class=" mt-2"  src="<?= base_url('uploads/img/'.$notice['image']) ?> " alt="" width="100" height="100">
                ...
                <div class="mb-3">
                    ...
                    <input type="time" class="form-control"  id="time" name="time" value="<?= $notice['time']?>">
