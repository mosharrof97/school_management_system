    ...
    <div class="row justify-content-center ">
        <div class="col-8 ">
            <div class="card view shadow my-5 print-area">
                <div class="card-header bg-primary d-flex justify-content-between  "> <h3><?= $page_heading; ?></h3> <a href="<?= base_url()?>dashboard/all_student" class="text-decoration-none btn  btn-close " type="button"  disabled aria-label="Close"></a></div>
                    <div id="data" class="">
