                            ...
                            <div class="author-items" style="border: 1px solid white">
                                    ...
                                    <div class="item">
                                        <div class="info" style="width: 100%; padding-top: 20px">
                                            <h5 class=" text-black "> <a class="notice-title text-black "  href=" <?= base_url('single-notice/'.$notice['notice_id'])?>" target="_blank"><?= $notice['title']?></a>
                                            </h5>
                                            <ul class="content-between align-items-center">
                                                ...
                                                <li style="" class="pull-right">
                                                    <a href="<?= base_url('single-notice/'.$notice['notice_id'])?> " target="_blank" class="btn  btn-prime ">
