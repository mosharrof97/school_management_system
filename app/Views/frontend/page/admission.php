    ...
    <div class="container">
        <div class="row content-between align-items-center p-2" id="heading-gradiant">
            ...
            <div class="col-sm-2 text-end">
                <a href="<?= base_url('/notice') ?>" class="btn btn-info btn-xs"> Refresh</a>
            </div>
        </div>
                                    ...
                                    <div class="info" style="width: 100%; padding-top: 20px">
                                        ...
                                        <ul class="content-between align-items-center">
                                            <li class="notice-date" style="">
                                                <h5 class=" text-black "> 
                                                    <a class="notice-title text-black "  href=" <?= base_url('admission-apply/'.$admission['admission_id'])?>" target="_blank"><?= $admission['admission_name']?></a>
                                                </h5>
                                            </li>
                                            <li style="" class="pull-right">
                                                <a href="<?= base_url('admission-apply/'.$admission['admission_id'])?> " target="_blank" class="btn  btn-prime ">
                                                    <i class="fas fa-plus"></i> Apply </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
